...
```{stan, output.var="normal",file='stan/normal.stan', eval=FALSE, echo=TRUE}
```

`stan/normal_vague.stan`

```{stan, output.var="normal_vague",file='stan/normal_vague.stan', eval=FALSE, echo=TRUE}
```
...
```{stan, output.var="pois",file='stan/pois.stan', eval=FALSE, echo=TRUE}
```

`stan/pois_re.stan`

```{stan, output.var="pois_re",file='stan/pois_re.stan', eval=FALSE, echo=TRUE}
```
...
```{stan, output.var="lm",file='stan/lm.stan', eval=FALSE, echo=TRUE}
```
```{r lm-model}
