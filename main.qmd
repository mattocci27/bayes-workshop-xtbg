...
- Sampling $\theta_1$, $\theta_2$ is hard: $p(\theta_1, \theta_2 \mid data) \propto p(data \mid \theta_1, \theta_2) \times p(\theta_1, \theta_2)$

- Instead, we can sample $\theta_1$ and $\theta_2$ sequentially:
