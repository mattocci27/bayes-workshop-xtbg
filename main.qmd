...
- However, given the similar scales of *x* and *y*, it's reasonable to guess that *a* falls within a narrow range (e.g., -5 to 5).
- In contrast, a slope like *a* = 100 (blue line) clearly doesn't match the data.
:::
...
- When the data $y_i$ is similar to the surrounding samples (e.g., spatial autocorrelation):
