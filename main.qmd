...
For simple models, we can find parameters that maximize the posterior distribution.


Coin A example again:
$$
\textcolor{#1b9e77}{\text{Posterior}} \propto
\textcolor{#d95f02}{p^{50}(1 - p)^{50}} \times
\textcolor{#7570b3}{p^2(1 - p)^1}
$$
